import { AdminPositionsClient } from "../components/AdminHumanResourcesClient";
...
import type { DivisionAdmin, PositionAdmin } from "../lib/types";
...
export default async function AdminPositionsPage() {
  ...
  try {
    ...
    return (
      <AdminServerShell activeView="positions" currentUser={currentUser}>
